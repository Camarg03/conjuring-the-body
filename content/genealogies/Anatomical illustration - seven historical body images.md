---
title: Anatomical illustration - seven historical body images
tags:
  - genealogies
  - anatomy
...
<dialog id="bbcAnatomyModal00" class="image-modal" onclick="this.close()">
  <img src="../assets/_104103251_portada.jpg.webp">
</dialog>
...
<figure>
  <img src="../assets/_104103257_sencillo.jpg.webp" class="popup-thumb" onclick="document.getElementById('bbcAnatomyModal01').showModal()">
...
<dialog id="bbcAnatomyModal01" class="image-modal" onclick="this.close()">
  <img src="../assets/_104103257_sencillo.jpg.webp">
</dialog>
...
<figure>
  <img src="../assets/_104106041_hombre-herido.jpg.webp" class="popup-thumb" onclick="document.getElementById('bbcAnatomyModal02').showModal()">
...
<dialog id="bbcAnatomyModal02" class="image-modal" onclick="this.close()">
  <img src="../assets/_104106041_hombre-herido.jpg.webp">
</dialog>
...
<figure>
  <img src="../assets/_102854524_dibujo-2.jpg.webp" class="popup-thumb" onclick="document.getElementById('bbcAnatomyModal03').showModal()">
...
<dialog id="bbcAnatomyModal03" class="image-modal" onclick="this.close()">
  <img src="../assets/_102854524_dibujo-2.jpg.webp">
</dialog>
...
<figure>
  <img src="../assets/_104106044_mujer.jpg.webp" class="popup-thumb" onclick="document.getElementById('bbcAnatomyModal04').showModal()">
...
<dialog id="bbcAnatomyModal04" class="image-modal" onclick="this.close()">
  <img src="../assets/_104106044_mujer.jpg.webp">
</dialog>
...
<figure>
  <img src="../assets/_104106046_con-la-piel.jpg.webp" class="popup-thumb" onclick="document.getElementById('bbcAnatomyModal05').showModal()">
...
<dialog id="bbcAnatomyModal05" class="image-modal" onclick="this.close()">
  <img src="../assets/_104106046_con-la-piel.jpg.webp">
</dialog>
...
<figure>
  <img src="../assets/_104106047_arrodillado.jpg.webp" class="popup-thumb" onclick="document.getElementById('bbcAnatomyModal06').showModal()">
...
<dialog id="bbcAnatomyModal06" class="image-modal" onclick="this.close()">
  <img src="../assets/_104106047_arrodillado.jpg.webp">
</dialog>
...
<figure>
  <img src="../assets/_104106048_posturas.jpg.webp" class="popup-thumb" onclick="document.getElementById('bbcAnatomyModal07').showModal()">
...
<dialog id="bbcAnatomyModal07" class="image-modal" onclick="this.close()">
  <img src="../assets/_104106048_posturas.jpg.webp">
</dialog>
...
<figure>
  <img src="../assets/_104103256_mecanico.jpg.webp" class="popup-thumb" onclick="document.getElementById('bbcAnatomyModal08').showModal()">
...
<dialog id="bbcAnatomyModal08" class="image-modal" onclick="this.close()">
  <img src="../assets/_104103256_mecanico.jpg.webp">
</dialog>
